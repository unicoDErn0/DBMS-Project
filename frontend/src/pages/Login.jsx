  ...
  return (
    <section className="min-h-screen flex items-center justify-center text-white relative">
      <img
        src={Designer}
        alt="designer"
        className="absolute inset-0 w-full h-full object-cover object-top bg-gray-500 bg-opacity-75"
      />
      ...
      <div className="absolute bg-gradient-to-b h-20 from-black to-transparent inset-0 z-0">
        <div className="flex items-center justify-center absolute top-4 left-4 mb-6 space-x-2">
          ...
          <div className="text-4xl font-bold text-white">Artemis</div>
        </div>
      </div>

      <div className="relative flex mx-auto w-[450px] flex-col lg:flex-row items-center justify-center bg-black bg-opacity-80 py-8 px-16 rounded-xl">
